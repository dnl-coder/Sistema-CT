...
if(isset($_POST['_codigoUsuario']) && isset($_POST['_accesos'])){

    //GUARDAR PARAMETROS EN VARIABLES
    
    $codeUser = $_POST['_codigoUsuario'];
    $acceso = $_POST['_accesos'];
    $acceso1=$acceso[0];
    $acceso2=$acceso[1];
    $acceso3=$acceso[2];
    $acceso4=$acceso[3];
